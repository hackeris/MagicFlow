...
> 可能让用户误以为这是官方出品/官方账号可用。本文为**排查清单**(只整理、未处理),
> 每项含:位置、什么时候会展示给用户、建议处置。
...
| A2 | 应用图标/桌面标签(label) | 系统桌面/任务栏 | 主项目 app.json5/module.json5 的 label 当前为 "ComfyUI"(W3 前已定?待确认)——改为本产品名 |
